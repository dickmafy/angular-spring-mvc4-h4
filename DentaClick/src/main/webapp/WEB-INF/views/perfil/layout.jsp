...
<div class="container">
	...
	<div class="demo-row">
		<div class="demo-title">PERFIL / LAYOUT</div>
		<div class="demo-content">
				...
				<form ng-submit="add(bean)">
					<div class="col-lg-8">
						<input class="form-control" placeholder="Ingresa nombre" type="text" ng-model="bean.nombre" required min="1" /> <input
							class="form-control" placeholder="Ingresa Descripcion" type="text" ng-model="bean.descripcion" required min="1" />
					</div>
				</form>
				<button class="btn btn-primary" ng-disabled="!bean" ng-hide="editMode" ng-click="add(bean)">Agregar Perfil</button>
			...
			<hr />
			<div class="alert alert-info" style="width: 400px; margin-left: 100px;" ng-show="beanList.length == 0">Ningun registro de perfil se encontro.
			</div>
			...
			<table class="table table-bordered table-striped" ng-show="beanList.length > 0">
				<thead>
					...
					<tr>
						...
						<th style="text-align: center;"><a href="" ng-click="reverse=!reverse;order('nombre', reverse)">NOMBRE </a></th>
						<th style="text-align: center;"><a href="" ng-click="reverse=!reverse;order('descripcion', reverse)">DESCRIPCION </a></th>
					</tr>
				</thead>
				<tbody>
					<!-- FILAS TABLA -->
